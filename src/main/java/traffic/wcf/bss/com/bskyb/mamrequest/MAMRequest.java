 ...
 * 2015-04-29T16:39:29.654+01:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "MAMRequest", 
                  wsdlLocation = "file:/Users/perrygil/AnypointStudio/workspace/cxf-client-test/src/main/resources/schema/MAMRequest.wsdl",
...
public class MAMRequest extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/perrygil/AnypointStudio/workspace/cxf-client-test/src/main/resources/schema/MAMRequest.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MAMRequest.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/perrygil/AnypointStudio/workspace/cxf-client-test/src/main/resources/schema/MAMRequest.wsdl");
        }
        WSDL_LOCATION = url;
    }
